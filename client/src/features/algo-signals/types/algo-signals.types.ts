// Mirrors trade-edge-api's algo-signals.types.ts, which mirrors phalanx-live's
// own document shapes as written straight to Atlas. Read-only, rendered
// defensively (fields can be missing if phalanx-live's schema drifts).
