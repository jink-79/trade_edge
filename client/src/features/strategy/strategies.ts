...
export const STRATEGIES = [
  { id: "trend-rs55", label: "Trend + RS-55", sub: "Daily · phalanx-live" },
  // Retired — kept selectable for viewing historical trades only.
...
export const DEFAULT_STRATEGY: StrategyId = "trend-rs55";
